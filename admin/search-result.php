...
<?php
    if($_POST){
        ...
        $sql=mysqli_query($database,"select * from mst_user where username like '%$query%' order by user_id");
                                                                            ...
                                                                            <div id="panel-element-<?php echo $rws['user_id']; ?>" class="panel-collapse collapse in">
                                                                                <div class="panel-body">
                                                                                    <div class="col-md-6 column">
                                                                                        <img src="../userfiles/avatars/<?php echo $rws['passport'];?>" width="200px" name="aboutme" class="img-responsive">                                  
                                                                                    </div>
                                                                                    <div class="col-md-6 column">
                                                                                        <div class="col-md-12 column">
                                                                                            <h2><span><?php echo $rws['username'];?> </span></h2>
                                                                                            <hr>
                                                                                            <p><?php echo $rws['user_shortbio'];?></p>
                                                                                            <hr>
                                                                                        </div>
                                                                                        <div class="col-md-4 column">
                                                                                             <a href="profile.php?login=<?php echo $rws['login'];?>"><button type="button" class="btn btn-primary">View</button></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
