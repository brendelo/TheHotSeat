...
<div class="profile">
	<div class="row clearfix">
		<!-- <div class="col-md-12 column"> -->
            <div>
                <center>
                    <img src="userfiles/avatars/<?php echo $rws['passport'];?>" alt="Administrator Profile Picture" class="img-responsive profile-avatar" width=300px;>
                    <br>
                    <div class="btn-group">
