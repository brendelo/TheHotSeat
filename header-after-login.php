...
require "components/database.php";
    ...
    $sql = "SELECT * FROM mst_user WHERE login='$current_user'";
...
<section class="navbar navbar-default navbar-fixed-top sticky-navigation" role="navigation">
	<div class="fluid-container">
		...
		<div class="navbar-header">
			...
			<a href="index.php" class="navbar-brand"><img src="userfiles/ARKTECH.PNG" alt="THE HOT SEAT" ></a>
		</div>
		            
				<div class="navbar-collapse collapse" id="navbar-collapse1">
	           <ul class="nav navbar-nav">
				<li>
                       <a href="index.php"><i class="fa fa-home smoothScroll"></i> Main Home</a>
                   </li>
	               <li>
                       <a href="profilehome.php"><i class="fa fa-home smoothScroll"></i> Proflie Home</a>
                   </li>
				   <!--<li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li> <a style="text-align:center;" href='profilehome.php'>Profile</a></li>
                        </ul>
                    </li>	
                    <li class="dropdown">
