...
<div class="profile">
	<div class="row clearfix">
		<!-- <div class="col-md-12 column"> -->
            <div>
                <center>
                    <img src="userfiles/avatars/<?php echo $rws['passport'];?>" alt="Candidate Profile Picture" class="img-responsive profile-avatar" width=250px;>
                    <br>
                    <div class="btn-group">
                        <a href="http://www.facebook.com/sharer.php?u=<?php echo $url ?> &t=<?php echo $rws['username'];?> " alt="Share this profile on Facebook" title="Share on Facebook" target="_blank" ><button type="button" class="btn btn-default"><i class="fa fa-facebook"></i></button></a>
                        <a href="http://twitter.com/share?text=<?php echo $rws['username'];?>&url=<?php echo $url ?>" alt="Tweet This Post" title="Tweet about the profile" target="_blank"><button type="button" class="btn btn-default"><i class="fa fa-twitter"></i></button></a>
...
<?php } ?>
                                ...
                                <div class="col-md-4 column">
                                    <p class="text-center profile-title"><i class="fa fa-info"></i> Results</p>
									
                                    <hr>

                                    <div class="col-md-4">
                                        <p class="profile-details"><i class="fa fa-info"></i> Results</p>
                                    </div>
                                    <div class="col-md-4">
                                        <p style="text-align: center;"><a href="result.php">VIEW</a></p>
                                    </div>
<?php
    if ($rws['user_twitter']){
?>   
